...
class Snake(tk.Canvas):
    ...
    def load_assets(self):
        try:
            self.snake_body_image = Image.open(r"C:\Users\joona\OneDrive\Tiedostot\Työpöytä\python_work\Snake game\assets\snake.png")
            self.snake_body = ImageTk.PhotoImage(self.snake_body_image)

            self.food_image = Image.open(r"C:\Users\joona\OneDrive\Tiedostot\Työpöytä\python_work\Snake game\assets\food.png")
